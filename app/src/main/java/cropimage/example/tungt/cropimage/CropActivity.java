...
import cropimage.example.tungt.cropimage.gesture.MoveGestureDetector;
import cropimage.example.tungt.cropimage.gesture.RotateGestureDetector;
...
public class CropActivity extends Activity implements OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap faceTemplate = BitmapFactory.decodeResource(getResources(), R.mipmap.face_oval);
        ...
        // Load temp image.
        Bitmap photoImg = BitmapFactory.decodeResource(getResources(), R.mipmap.temp_image);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == MEDIA_GALLERY) {
                ...
                switch(pos) {
                    case 0:
                        templateImg = BitmapFactory.decodeResource(getResources(), R.mipmap.face_oblong);
                        break;
                    case 1:
                        templateImg = BitmapFactory.decodeResource(getResources(), R.mipmap.face_oval);
                        break;
                    case 2:
                        templateImg = BitmapFactory.decodeResource(getResources(), R.mipmap.face_round);
                        break;
                    case 3:
                        templateImg = BitmapFactory.decodeResource(getResources(), R.mipmap.face_square);
                        break;
                    case 4:
                        templateImg = BitmapFactory.decodeResource(getResources(), R.mipmap.face_triangular);
                        break;
                }
